...
function Game() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      {winner && <button onClick={refreshPage} className='bg-blue-500 mt-4 p-2 rounded-lg hover:bg-blue-600 text-white'>Start over</button>}
      <div className='text-sm text-gray-600 mt-4'>Beware that on guest session your progress will be lost even if you refresh the website!</div>
    </div>
  );
}
